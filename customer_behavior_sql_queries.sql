...
-- Q1. What is the total revenue generated by male vs. female characters?
...
SELECT item_purchased,
       ROUND((SUM(CASE WHEN discount_applied = 'Yes' THEN 1 ELSE 0 END) * 1.0) 
             / COUNT(*) * 100, 2) AS purchase_percentage
FROM customer
GROUP BY item_purchased
...
SELECT customer_segment, COUNT(*) AS Numberof_Customers
FROM customer_type
